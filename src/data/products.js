...
const placeholderImg = MomentImg
...
export const newArrivals = [
  ...
  {
    id: 13,
    name: "Clutch Pro Earbuds",
    spec: "50ms low latency | ENC | Gaming Mode | RGB Fusion Lights",
    price: 7595,
    originalPrice: 9995,
    rating: 4.9,
    category: 'earbuds',
  ...
  },
  {
    id: 14,
    name: "Rage Neckband",
    spec: "Super Bass Effect | Stereo Sound | Premium Metallic Finish",
    price: 3995,
    originalPrice: 5995,
    rating: 4.7,
    category: 'neckbands',
  ...
  {
    id: 15,
    name: "Torque Pro Clip Charger Type-C",
    spec: "Universal Clip Charger | 45W Charging",
    price: 1395,
    originalPrice: 1595,
    rating: 4.6,
    category: 'chargers',
  ...
  {
    id: 16,
    name: "Fuel Cell - Pack of 4",
    spec: "Rechargeable AAA Power Cell | Type-C Charging | 1000+ Lifecycles",
    price: 2595,
    originalPrice: 4330,
    rating: 4.5,
  ...
  {
    id: 17,
    name: "Fuel Pro Cell - Pack of 4",
    spec: "Rechargeable AA Power Cell | Type-C Charging | 1000+ Lifecycles",
    price: 2795,
    originalPrice: 4710,
    rating: 4.5,
    category: 'power-banks',
  ...
  {
    id: 18,
    name: "Wizard X Charger",
    spec: "45W | Super VOOC | PD/QC | GaN | Fast Charger | AFC",
    price: 3095,
    originalPrice: 3995,
    rating: 4.8,
    category: 'chargers',
  ...
  {
    id: 19,
    name: "Majestik Audio Pro",
    spec: "80W Cinematic Sound | 3 EQ Sound Modes",
    price: 22995,
    originalPrice: 29095,
    rating: 4.9,
    category: 'speaker',
  ...
  },
  {
    id: 20,
    name: "Majestik Audio",
    spec: "60W 2.1 Channel Soundbar with Subwoofer",
    price: 17995,
    originalPrice: 23695,
    rating: 4.8,
    category: 'speaker',
  ...
  },
  {
    id: 21,
    name: "Pebble Earbuds",
    spec: "10th Anniversary Limited Edition Buds | Studio Grade Sound",
    price: 6995,
    originalPrice: 8995,
    rating: 4.8,
    category: 'earbuds',
    image: LucidImg,
    tag: "LIMITED EDITION",
    tagColor: "bg-gradient-to-b from-amber-400 to-orange-700",
  },
  {
    id: 22,
    name: "Vector Earbuds",
    spec: "ANC | Cinematic Sound | Heavy Bass | ENC | Quad Mic",
    price: 6995,
    originalPrice: 8175,
    rating: 4.9,
    category: 'earbuds',
  ...
  {
    id: 23,
    name: "Mist Pro Earbuds",
    spec: "Active Noise Cancellation | ENC | Noise-Free Calls | Immersive Sound",
    price: 6295,
    originalPrice: 7595,
    rating: 4.9,
    category: 'earbuds',
  ...
  {
    id: 24,
    name: "Magnus Headphone",
    spec: "Dedicated Active Noise Cancellation | Mood Tuned Sound",
    price: 6995,
    originalPrice: 9995,
    rating: 4.8,
    category: 'headphones',
  ...
  {
    id: 25,
    name: "Momentum Headphone",
    spec: "Feather Light Weight | Immersive Sound | Soft Cushions",
    price: 4995,
    originalPrice: 6995,
    rating: 4.7,
    category: 'headphones',
  ...
  },
  {
    id: 26,
    name: "Cord Neckband",
    spec: "ENC | Crystal Clear Calling | 4 Band Equalizer | Magnetic Buds",
    price: 4995,
    originalPrice: 6495,
    rating: 4.8,
    category: 'neckbands',
  ...
  {
    id: 27,
    name: "Hurricane Headphone",
    spec: "25ms Ultra-Low Latency | Gaming Headphones | Play Station | Laptop | Mobile",
    price: 8995,
    originalPrice: 11995,
    rating: 4.9,
    category: 'headphones',
    ...
    tagColor: "bg-gradient-to-b from-violet-500 to-purple-800",
  },
  {
    id: 28,
    name: "Fury X Pro Charger",
    spec: "33W Fast Charging | Super VOOC | GaN | PD & QC | AFC",
    price: 2545,
    originalPrice: 3545,
    rating: 4.7,
    category: 'chargers',
  ...
  },
  {
    id: 29,
    name: "Xpress Charger",
    spec: "20W Fast Charging | PD & QC | Super VOOC | AFC",
    price: 1595,
    originalPrice: 1795,
    rating: 4.6,
    category: 'chargers',
  ...
  {
    id: 30,
    name: "Voltedge Charger",
    spec: "Auto ID | Multi Device Charging",
    price: 1095,
    originalPrice: 1495,
    rating: 4.5,
    category: 'chargers',
  ...
  {
    id: 31,
    name: "Clarity Vlogging Mic",
    spec: "AI Noise-Cancelling Mic | Vlogging | Content | Podcast",
    price: 9895,
    originalPrice: 10995,
    rating: 4.8,
    category: 'vlogging-mics',
    image: MomentImg,
    tag: "AI POWERED MIC",
    tagColor: "bg-gradient-to-b from-violet-500 to-indigo-800",
  },
  {
    id: 32,
    name: "Retro Speaker",
    spec: "Architectural Speaker | Fiber Textured Built",
    price: 5995,
    originalPrice: 6995,
    rating: 4.7,
    category: 'speaker',
  ...
  {
    id: 33,
    name: "Limited Edition Buds Hasan Raheem",
    spec: "Glacier Earbuds | Co-tuned & Co-designed by Hasan Raheem",
    price: 8995,
    originalPrice: 12995,
    rating: 5.0,
    category: 'earbuds',
    image: LucidImg,
    tag: "LIMITED EDITION BY HR",
    tagColor: "bg-gradient-to-b from-amber-400 to-orange-700",
  },
  {
    id: 34,
    name: "TAG R-202 Smart Tracker",
    spec: "Smart Tracker | For iOS",
    price: 3495,
    originalPrice: 3995,
    rating: 4.4,
    category: 'trackers',
  ...
  {
    id: 35,
    name: "Reactor X Earbuds",
    spec: "28ms Industry's Lowest Ever Latency | Type-C Wireless Connector | ANC & ENC",
    price: 7795,
    originalPrice: 8595,
    rating: 4.9,
    category: 'earbuds',
  ...
  {
    id: 36,
    name: "Iron Edge Earbuds",
    spec: "Gaming Buds | Fidget Spinner Design | 40ms Ultra Low Latency | RGB Lights | ENC",
    price: 8795,
    originalPrice: 9995,
    rating: 4.8,
    category: 'earbuds',
  ...
  },
  {
    id: 37,
    name: "Vox Earbuds",
    spec: "Hybrid ANC & ENC | Cinematic Sound | 40 Hr Playtime",
    price: 6595,
    originalPrice: 8595,
    rating: 4.9,
    category: 'earbuds',
  ...
  },
  {
    id: 38,
    name: "Vesper Earbuds",
    spec: "Dual Connectivity | Immersive Sound | ANC & ENC",
    price: 6595,
    originalPrice: 7595,
    rating: 4.8,
    category: 'earbuds',
  ...
  },
  {
    id: 39,
    name: "Nox Earbuds",
    spec: "Leather Finish Earbuds | Dual Connectivity | ENC & ANC | Quad Mic",
    price: 6295,
    originalPrice: 6995,
    rating: 4.8,
    category: 'earbuds',
  ...
  },
  {
    ...
    spec: "Hyper ANC | AI ENC (QnX) | Up to 80 Hr",
    price: 6995,
    originalPrice: 8995,
    rating: 4.9,
    category: 'earbuds',
  ...
  },
  {
    id: 41,
    name: "Snap Earbuds",
    spec: "Tap, Snap, Scroll Reels with Earbuds | Half In-Ear | Dual Connectivity",
    price: 5595,
    originalPrice: 7595,
    rating: 4.7,
    category: 'earbuds',
    image: LucidImg,
    tag: "REEL SCROLLER",
    tagColor: "bg-gradient-to-b from-pink-500 to-violet-700",
  },
  {
    id: 42,
    name: "Dominator Earbuds",
    spec: "40ms Ultra Low Latency | Gaming Buds | Swoosh Sound | Metallic Build",
    price: 6995,
    originalPrice: 7995,
    rating: 4.9,
    category: 'earbuds',
